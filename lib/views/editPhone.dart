...
class _EditPhoneState extends State<EditPhone> {
        ...
        FutureBuilder<PhoneModel>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return   Column(
            children: [_phoneInput(),_countryCodeInput(), _areaCodeInput(), typeSelect(phone?.phoneType)]);
            }
          },
        ), 
      ),
  ...
  Widget typeSelect(value) {
   ...
   value: value,
    ...
    saveData() async{
      PhoneModel phone = PhoneModel(phoneId:widget.phoneId, phone: _phoneController.text, studentId: studentId, phoneType: phone_type, areaCode: _areaCodeController.text, countryCode: _countryCodeController.text);
