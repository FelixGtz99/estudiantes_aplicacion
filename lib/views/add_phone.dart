...
class _AddPhoneState extends State<AddPhone> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
            children: [_phoneInput(),_countryCodeInput(), _areaCodeInput(), typeSelect()]),
      ),
    );
  }
  ...
  Widget typeSelect() {
    ...
    saveData() async{
      PhoneModel phone = PhoneModel(phone: _phoneController.text, studentId: widget.studentId, phoneType: phone_type, areaCode: _areaCodeController.text, countryCode: _countryCodeController.text);
