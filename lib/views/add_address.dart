...
class _AddAddressState extends State<AddAddress> {
  ...
  Widget _stateInput() {
    ...
    saveData() async{
     AddressModel address = AddressModel(studentId: widget.studentId, addressLine: _addressLineController.text, city: _cityController.text, zipPostcode: _zipController.text, state: _stateController.text);
